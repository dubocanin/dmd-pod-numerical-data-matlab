snapshots - extracted snapshots (.csv files) are saved in this folder
...
pod - sripts and functions for performing the POD analysis
		...
		2. for increased number of modes, the reconstruction can
		  take some time, comment out for quicker analysis

dmd - sripts and functions for performing the DMD analysis

colormaps - custom versions of colormaps that can be loaded into plot functions

data - .mat files used to perform POD/DMD analysis
